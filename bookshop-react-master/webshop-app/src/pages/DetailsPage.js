...
function DetailsPage() {
  ...
  const getRandomRating = () => {
    const minRating = 0; // Minimum rating value
        ...
        {book ? (
          <div className="container container-footer" id="container">
            <div className="name mt-3">
              <h4 className="name details-name" id="name">
                {book.name}
              </h4>
                ...
                >
                  {book.discount > 0 ? (
                    <h5>
                      ...
                      <span id="price">{book.price - 10}</span> RON
                    </h5>
                  ) : (
                    <h5>
                      Price : <span id="price">{book.price}</span> RON
                    </h5>
                  )}
                  <div id="rating">
